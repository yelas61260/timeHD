					...
					<table class="form_header">
						...
						<tr>
							<td>
								...
								<div class="form-input"><input type="date" name="fecha_ini_real" id="fecha_ini_real" size="45" value="" required/></div>
							</td>
						</tr>
						<tr>
							<td>
								<div class="form-label"><label for="fecha_fin_real">Fecha real de finalización:</label></div>
								<div class="form-input"><input type="date" name="fecha_fin_real" id="fecha_fin_real" size="45" value="" required/></div>
							</td>
						</tr>
						<tr>
							<td>
